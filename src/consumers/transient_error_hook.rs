use super::{incoming_message::Delivery, BrokerAction};
...
impl From<ShouldRequeue> for BrokerAction {
    fn from(value: ShouldRequeue) -> Self {
        match value {
            ShouldRequeue::Requeue => Self::Nack,
            ShouldRequeue::Discard => Self::Ack,
            ShouldRequeue::DeadLetterOrDiscard => Self::Reject,
        }
    }
}
